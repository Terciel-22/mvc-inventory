<?php 
    ...
    class UserView
    {
        function renderLoginForm($errors=array())
        {
            ...
            $html .= "<span class='error' id='email-err'>$email_err</span>";
            $html .= "</div>";
            $html .= "<div>";
            $html .= "<input type='password' id='password' name='password' value='$old_password' placeholder='Type your password'/>";
            $html .= "<span class='error' id='password-err'>$password_err</span>";
            $html .= "</div>";
            $html .= "<div>";
            $html .= "<button type='submit'>Login</button>";
            $html .= "<button type='button' id='login-reset'>Reset</button>";
            $html .= "</div>";
            $html .= "</form>";
        ...
        function renderRegistrationForm($errors=array())
        {
            ...
            $html .= "<span class='error' id='name-err'>$name_err</span>";
            $html .= "</div>";
            $html .= "<div>";
            $html .= "<input type='email' id='email' name='email' value='$old_email' placeholder='Type your email'/>";
            $html .= "<span class='error' id='email-err'>$email_err</span>";
            ...
            $html .= "</div>";
            $html .= "<div>";
            $html .= "<input type='password' id='cpassword' name='cpassword' placeholder='Confirm your password'/>";
            $html .= "</div>";
            $html .= "<div>";
            $html .= "<button type='submit'>Register</button>";
            $html .= "<button type='button' id='registration-reset'>Reset</button>";
            $html .= "</div>";
            $html .= "</form>";
